...
@Composable
fun DetailedAnalysisDiscardScreen(navController: NavController, name: String?, email: String?) {
    Scaffold(
        topBar = {
            TopAppBar(
        ...
        Column(
            ...
            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceAround) {
                SegmentResultCard(segment = "Seg 1", hasError = true)
                SegmentResultCard(segment = "Seg 2")
                SegmentResultCard(segment = "Seg 3", hasError = true)
            }
